run_netflix_country_analysis <- function() {
  ...
  # Highlight top 2 countries in red
  content_distribution <- content_distribution %>%
    mutate(
      color = ifelse(row_number() <= 2, "#E50914", "gray70")
    )
  
  # Plot top 20 countries by content count
  ...
  # Save top 20 creators plot
  ggsave(
    filename = "top20creators.png",
    plot = top20creators,
  ...
  # Analysis 2: Ratings by country (min 30 movies)
  ...
  # Save country rating plot
  ggsave(
    filename = "countryrating.png",
    plot = countryrating,
    path = "C:/Users/pmnha/my-new-project/22660348/Question3/Results",
    width = 10,
    height = 6,
  ...
  # Plot emerging market performance
  ...
  # Save emerging markets plot
  ggsave(
    filename = "emergers.png",
    plot = emergers,
    path = "C:/Users/pmnha/my-new-project/22660348/Question3/Results",
    width = 10,
    height = 6,
